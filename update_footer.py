...
replacement = '''            <div class="footer-contact-details">
              <style>
                .contact-social-icons {
                  display: flex;
                  gap: 15px;
...
content = content.replace('<h3 class="footer-col-title">Contact</h3>', '<h3 class="footer-col-title contact-centered">Contact</h3>')
